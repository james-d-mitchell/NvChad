...
" comments
syn match gapComment "\(#.*\)*" contains=gapTodo,gapFunLine,gapFixme

syn match hgConflict "\(<<<<<<<\|=======\|>>>>>>>\)"
...
syn keyword gapFixme FIXME contained
syn keyword gapTodo XXX contained
syn keyword gapTodo Notes contained
syn keyword gapTodo Usage contained
syn keyword gapTodo Returns contained
syn keyword gapTodo JDM contained
...
syn keyword gapOtherKey         Unbind IsBound
syn keyword gapInfo             Info
...
" use gvim
hi gapString ctermfg=2 guifg=#859900
hi gapFunction  ctermfg=1 guifg=#b58900
hi gapDeclare ctermfg=4 guifg=#0b5365
hi gapMethsel cterm=none guifg=#0b5365
hi gapOtherKey  ctermfg=blue guifg=#268bd2 
hi gapOperator cterm=bold ctermfg=1 guifg=#dc322f
hi gapConditional ctermfg=green guifg=#cb4b16
hi gapRepeat ctermfg=green guifg=#859900
hi gapComment cterm=none ctermfg=white cterm=italic ctermbg=Blue guifg=red gui=italic
hi gapTodo  ctermbg=2 ctermfg=0 guibg=lightgreen guifg=black
hi link gapTTodoComment  gapTodo
hi link gapTodoComment  gapComment
hi gapNumber ctermfg=2 guifg=#859900
hi gapBool ctermfg=blue guifg=#6c71c4
hi gapChar ctermfg=3 guifg=#b58900
hi gapListDelimiter ctermfg=8 guifg=#657b83
hi gapParentheses ctermfg=12 guifg=#586e75
hi gapSublist ctermfg=14 guifg=#2aa198
hi gapFunLine ctermbg=3 ctermfg=0 guibg=darkyellow guifg=black
hi gapInfo guibg=#268bd2 guifg=white 
hi gapFixme guibg=red guifg=black
hi hgConflict guibg=red guifg=black
...
" for w in NamesGVars() do AppendTo("~/.config/nvim/GAPWORDS",w,"\n"); od;    )
set complete=.,w,b,u,t,i,k~/.config/nvim/GAPWORDS
...
hi IncSearch guibg=green gui=underline
" vim: ts=2
